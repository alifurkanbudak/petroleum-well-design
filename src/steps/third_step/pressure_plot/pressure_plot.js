...
export default function PressurePlot({ casing, sliderParams, plotData, setPlotData }) {
    ...
    return (
        <Box sx={{ ml: 2, mr: 2, width: '34%' }}>
            ...
            <LineChart width={475} height={400} data={plotData}>
                <Line type="monotone" dataKey="Reservoir Pressure" stroke="#BE2A2C" />
                <Line type="monotone" dataKey="Mud Pressure" stroke="#060606" />
                <Line type="monotone" dataKey="Fracture Pressure" stroke="#9DCA44" />
